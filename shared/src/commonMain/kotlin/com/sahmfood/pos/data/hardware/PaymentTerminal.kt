...
interface PaymentTerminal {
    suspend fun chargeCard(amount: Double, description: String): TerminalResult
    suspend fun chargeMobileWallet(amount: Double, walletType: String): TerminalResult
}
...
class MockPaymentTerminal : PaymentTerminal {
    ...
    override suspend fun chargeCard(amount: Double, description: String): TerminalResult {
